                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col align-self-center">
                                <div class="media">
                                    <img src="assets/admin/images/logos/money-beg.png" alt="" class="align-self-center" height="40">
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <tr>                                                        
                                        <td>
                                            <div class="media">
                                                <img src="assets/admin/images/products/01.png" height="30" class="me-3 align-self-center rounded" alt="...">
                                    ...
                                    <tr>                                                        
                                        <td>
                                            <div class="media">
                                                <img src="assets/admin/images/products/02.png" height="30" class="me-3 align-self-center rounded" alt="...">
                                                <div class="media-body align-self-center"> 
                                    ...
                                    <tr>                                                        
                                        <td>
                                            <div class="media">
                                                <img src="assets/admin/images/products/04.png" height="30" class="me-3 align-self-center rounded" alt="...">
                                                <div class="media-body align-self-center"> 
                                    ...
                                    <tr>                                                        
                                        <td>
                                            <div class="media">
                                                <img src="assets/admin/images/products/07.png" height="30" class="me-3 align-self-center rounded" alt="...">
                                                <div class="media-body align-self-center"> 
                                    ...
                                    <tr>                                                        
                                        <td>
                                            <div class="media">
                                                <img src="assets/admin/images/products/05.png" height="30" class="me-3 align-self-center rounded" alt="...">
                                                <div class="media-body align-self-center"> 
