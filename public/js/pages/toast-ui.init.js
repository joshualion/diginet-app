var barChartWidth = document.getElementById("bar-charts").offsetWidth,
  ...
  data = {
    ...
    series: [
      { name: "Budget", data: [5e3, 3e3, 5e3, 7e3, 6e3, 4e3] },
      { name: "Income", data: [8e3, 1e3, 7e3, 2e3, 5e3, 3e3] },
    ],
  },
  options = {
    chart: {
    ...
    yAxis: { title: "Month" },
    xAxis: { title: "Amount", min: 0, max: 9e3, suffix: "$" },
    series: { showLabel: !1 },
  },
  theme = {
  ...
  columnChartWidth =
    (window.addEventListener("resize", function () {
      (barChartWidth = document.getElementById("bar-charts").offsetWidth),
        barChart.resize({ width: barChartWidth, height: 350 });
    }),
    document.getElementById("column-charts").offsetWidth),
  ...
  data = {
    ...
    series: [
      { name: "Budget", data: [5e3, 3e3, 5e3, 7e3, 6e3, 4e3, 1e3] },
      { name: "Income", data: [8e3, 1e3, 7e3, 2e3, 6e3, 3e3, 5e3] },
      { name: "Expenses", data: [4e3, 4e3, 6e3, 3e3, 4e3, 5e3, 7e3] },
    ],
  },
  options = {
    chart: {
    ...
    yAxis: { title: "Amount", min: 0, max: 9e3 },
    xAxis: { title: "Month" },
    legend: { align: "top" },
  },
  theme = {
    ...
    plot: { lineColor: "rgba(166, 176, 207, 0.1)" },
    legend: { label: { color: "#8791af" } },
    series: { colors: ["#0B6E44", "#1ccab8", "#eeeab5"] },
  },
  columnChart =
    (tui.chart.registerTheme("myTheme", theme),
    (options.theme = "myTheme"),
  ...
  lineChartWidth =
    (window.addEventListener("resize", function () {
      (columnChartWidth = document.getElementById("column-charts").offsetWidth),
        columnChart.resize({ width: columnChartWidth, height: 350 });
    }),
    document.getElementById("line-charts").offsetWidth),
  container = document.getElementById("line-charts"),
  data = {
    categories: ["June", "July", "Aug", "Sep", "Oct", "Nov"],
    series: [
      { name: "Budget", data: [5e3, 3e3, 6e3, 3e3, 6e3, 4e3] },
      { name: "Income", data: [8e3, 1e3, 7e3, 2e3, 5e3, 3e3] },
      { name: "Outgo", data: [900, 6e3, 1e3, 9e3, 3e3, 1e3] },
    ],
  },
  options = {
    chart: {
    ...
    yAxis: { title: "Amount", pointOnColumn: !0 },
    xAxis: { title: "Month" },
  ...
  areaChartWidth =
    (window.addEventListener("resize", function () {
      (lineChartWidth = document.getElementById("line-charts").offsetWidth),
        lineChart.resize({ width: lineChartWidth, height: 350 });
    }),
    document.getElementById("area-charts").offsetWidth),
  ...
  data = {
    ...
    series: [
      ...
      { name: "Moskva", data: [30, 5, 18, 21, 33, 41, 29, 15, 30, 10, 33, 5] },
    ],
  },
  options = {
    chart: {
    ...
    yAxis: { title: "Temperature (Celsius)", pointOnColumn: !0 },
    xAxis: { title: "Month" },
    tooltip: { suffix: "°C" },
  },
  theme = {
  ...
  radialChartWidth =
    (window.addEventListener("resize", function () {
      (areaChartWidth = document.getElementById("area-charts").offsetWidth),
        areaChart.resize({ width: areaChartWidth, height: 350 });
    }),
    document.getElementById("radial-charts").offsetWidth),
  container = document.getElementById("radial-charts"),
  data = {
    categories: ["Jan", "Feb", "Mar", "April", "May", "Jun"],
    series: [
      { name: "Budget", data: [5e3, 3e3, 5e3, 7e3, 6e3, 4e3] },
      { name: "Income", data: [8e3, 8e3, 7e3, 2e3, 5e3, 3e3] },
      { name: "Expenses", data: [4e3, 4e3, 6e3, 3e3, 4e3, 5e3] },
      { name: "Debt", data: [6e3, 3e3, 3e3, 1e3, 2e3, 4e3] },
    ],
  },
  options = {
    chart: { title: "Annual Incomes", width: radialChartWidth, height: 380 },
  ...
  theme = {
    ...
    plot: { lineColor: "rgba(166, 176, 207, 0.1)" },
    legend: { label: { color: "#8791af" } },
    series: { colors: ["#0B6E44", "#1ccab8", "#eeeab5", "#ecedf1"] },
  },
  radialChart =
    (tui.chart.registerTheme("myTheme", theme),
    (options.theme = "myTheme"),
  ...
  bubbleChartWidth =
    (window.addEventListener("resize", function () {
      (radialChartWidth = document.getElementById("radial-charts").offsetWidth),
        radialChart.resize({ width: radialChartWidth, height: 350 });
    }),
    document.getElementById("bubble-charts").offsetWidth),
  ...
  data = {
    series: [
      ...
      },
      {
        name: "Asia",
        data: [
          { x: 5600, y: 71.96, r: 92988e3, label: "China" },
          ...
          { x: 12e3, y: 75.23, r: 25795938, label: "Saudi Arabia" },
      ...
      },
      {
        ...
        data: [
          ...
          { x: 12e3, y: 74.16, r: 38626349, label: "Poland" },
          ...
          { x: 29e3, y: 78.24, r: 5214512, label: "Finland" },
  ...
  options = {
    chart: {
      ...
      format: function (e, t, a, r) {
        return (
          ("r" !== r && "x" !== r) ||
            ((e = tui.chart.renderUtil.formatToComma(e)),
            "x" === r && (e = "$" + e)),
          e
        );
      },
    ...
    tooltip: {
      template: function (e, t) {
        return (
          '<div class="tui-chart-default-tooltip"><div class="tui-chart-tooltip-head"><span class="tui-chart-legend-rect" style="' +
          t.cssText +
          '; width: 10px; height: 10px"></span><span>' +
          t.legend +
          "</span><span>" +
          t.label +
          '</span></div><table class="tui-chart-tooltip-body"><tr><td>GDP</td><td class="tui-chart-tooltip-value">' +
          t.x +
          '</td></tr><tr><td>Life Expectancy</td><td class="tui-chart-tooltip-value">' +
          t.y +
          '</td></tr><tr><td>Population</td><td class="tui-chart-tooltip-value">' +
          t.r +
          "</td></tr></table>"
        );
      },
  ...
  scatterChartWidth =
    (window.addEventListener("resize", function () {
      (bubbleChartWidth = document.getElementById("bubble-charts").offsetWidth),
        bubbleChart.resize({ width: bubbleChartWidth, height: 350 });
    }),
    document.getElementById("scatter-charts").offsetWidth),
  ...
  options = {
    chart: { width: scatterChartWidth, height: 380, title: "Height vs Weight" },
    yAxis: { title: "Weight (kg)" },
    xAxis: { title: "Height (cm)" },
    tooltip: {
      template: function (e, t) {
        return (
          '<div class="tui-chart-default-tooltip"><div class="tui-chart-tooltip-head">' +
          t.legend +
          '</div><table class="tui-chart-tooltip-body"><tr><td>Weight</td><td class="tui-chart-tooltip-value">' +
          t.x +
          'kg</td></tr><tr><td>Height</td><td class="tui-chart-tooltip-value">' +
          t.y +
          "cm</td></tr></table></div>"
        );
      },
  ...
  pieChartWidth =
    (window.addEventListener("resize", function () {
      (scatterChartWidth =
        document.getElementById("scatter-charts").offsetWidth),
        scatterChart.resize({ width: scatterChartWidth, height: 350 });
    }),
    document.getElementById("pie-charts").offsetWidth),
  container = document.getElementById("pie-charts"),
  data = {
    categories: ["Browser"],
    series: [
      { name: "Chrome", data: 46.02 },
      { name: "IE", data: 20.47 },
      { name: "Firefox", data: 17.71 },
      { name: "Safari", data: 5.45 },
      { name: "Etc", data: 10.35 },
    ],
  },
  options = {
  ...
  theme = {
    ...
    plot: { lineColor: "rgba(166, 176, 207, 0.1)" },
    legend: { label: { color: "#8791af" } },
    series: { colors: ["#0B6E44", "#1ccab8", "#eeeab5", "#ef4586", "#f1b44c"] },
  },
  pieChart =
    (tui.chart.registerTheme("myTheme", theme),
    (options.theme = "myTheme"),
  ...
  donutpieChartWidth =
    (window.addEventListener("resize", function () {
      (pieChartWidth = document.getElementById("pie-charts").offsetWidth),
        pieChart.resize({ width: pieChartWidth, height: 350 });
    }),
    document.getElementById("donut-charts").offsetWidth),
  ...
  theme = {
    ...
    series: {
      series: {
        colors: ["#0B6E44", "#1ccab8", "#eeeab5", "#ef4586", "#f1b44c"],
      },
      label: { color: "#fff", fontFamily: "sans-serif" },
    },
  },
  donutChart =
    (tui.chart.registerTheme("myTheme", theme),
  ...
  heatmapchartsWidth =
    ...
    document.getElementById("heatmap-charts").offsetWidth),
  ...
  data = {
    ...
    series: [
      [-3.5, -1.1, 4, 11.3, 17.5, 21.5, 24.9, 25.2, 20.4, 13.9, 6.6, -0.6],
      ...
      [-13.2, -13.7, -13.1, -10.3, -6.1, -3.2, 0, -0.1, -1.8, -4.5, -9, -10.9],
    ],
  },
  options = {
    chart: {
  ...
  treemapchartsWidth =
    (window.addEventListener("resize", function () {
      (heatmapChartChartWidth =
        document.getElementById("heatmap-charts").offsetWidth),
        heatmapChart.resize({ width: heatmapChartChartWidth, height: 350 });
    }),
    document.getElementById("treemap-charts").offsetWidth),
  ...
  data = {
    series: [
      ...
      },
      {
        label: "Downloads",
        children: [
          { label: "recents", value: 5.3 },
          { label: "2015", value: 10.1 },
          { label: "2014", value: 8.2 },
        ],
      },
      { label: "Application", value: 16.4 },
      { label: "Desktop", value: 4.5 },
    ],
  },
  options = {
    chart: { width: treemapchartsWidth, height: 380, title: "Used disk space" },
  ...
  theme = {
    ...
    legend: { label: { color: "#8791af" } },
    series: {
      colors: ["#0B6E44", "#1ccab8", "#eeeab5", "#ef4586"],
  ...
  mapchartsWidth =
    (window.addEventListener("resize", function () {
      (treemapChartChartWidth =
        document.getElementById("treemap-charts").offsetWidth),
        treemapChart.resize({ width: treemapChartChartWidth, height: 350 });
    }),
    document.getElementById("map-charts").offsetWidth),
  container = document.getElementById("map-charts"),
  data = {
    series: [
      { code: "US-AK", data: -3 },
      { code: "US-AL", data: 17.1 },
      { code: "US-AZ", data: 15.7 },
      { code: "US-CA", data: 15.2 },
      { code: "US-CO", data: 7.3 },
      { code: "US-CT", data: 9.4 },
      { code: "US-DC", data: 12.3 },
      { code: "US-DE", data: 12.9 },
      { code: "US-FL", data: 21.5 },
      { code: "US-GA", data: 17.5 },
      { code: "US-HI", data: 21.1 },
      { code: "US-IA", data: 8.8 },
      { code: "US-ID", data: 6.9 },
      { code: "US-IL", data: 11 },
      { code: "US-IN", data: 10.9 },
      { code: "US-KS", data: 12.4 },
      { code: "US-KY", data: 13.1 },
      { code: "US-LA", data: 19.1 },
      { code: "US-MA", data: 8.8 },
      { code: "US-MD", data: 12.3 },
      { code: "US-ME", data: 5 },
      { code: "US-MI", data: 6.9 },
      { code: "US-MN", data: 5.1 },
      { code: "US-MO", data: 12.5 },
      { code: "US-MS", data: 17.4 },
      { code: "US-NC", data: 15 },
      { code: "US-ND", data: 4.7 },
      { code: "US-NE", data: 9.3 },
      { code: "US-NH", data: 6.6 },
      { code: "US-NJ", data: 11.5 },
      { code: "US-NM", data: 11.9 },
      { code: "US-NV", data: 9.9 },
      { code: "US-NY", data: 7.4 },
      { code: "US-OH", data: 10.4 },
      { code: "US-OK", data: 15.3 },
      { code: "US-OR", data: 9.1 },
      { code: "US-PA", data: 9.3 },
      { code: "US-RI", data: 10.1 },
      { code: "US-SC", data: 16.9 },
      { code: "US-SD", data: 7.3 },
      { code: "US-TN", data: 14.2 },
      { code: "US-TX", data: 18.2 },
      { code: "US-UT", data: 9.2 },
      { code: "US-VA", data: 12.8 },
      { code: "US-VT", data: 6.1 },
      { code: "US-WA", data: 9.1 },
      { code: "US-WI", data: 11 },
      { code: "US-WV", data: 6.2 },
  ...
  boxplotchartsWidth =
    (window.addEventListener("resize", function () {
      (mapChartChartWidth = document.getElementById("map-charts").offsetWidth),
        mapChart.resize({ width: mapChartChartWidth, height: 350 });
    }),
    document.getElementById("boxplot-charts").offsetWidth),
  ...
  options = {
    ...
    yAxis: { title: "Amount", min: 0, max: 15e3 },
    xAxis: { title: "Month" },
    legend: { align: "bottom" },
  },
  theme = {
  ...
  bulletchartsWidth =
    (window.addEventListener("resize", function () {
      (boxplotChartChartWidth =
        document.getElementById("boxplot-charts").offsetWidth),
        boxplotChart.resize({ width: boxplotChartChartWidth, height: 350 });
    }),
    document.getElementById("bullet-charts").offsetWidth),
...
window.addEventListener("resize", function () {
  (bulletChartWidth = document.getElementById("bullet-charts").offsetWidth),
    bulletChart.resize({ width: bulletChartWidth, height: 350 });
});
